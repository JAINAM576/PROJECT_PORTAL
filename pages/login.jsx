  ...
  return (
    <div>
      ...
      <div className="flex h-screen justify-center items-center relative bg-login-background bg-no-repeat bg-cover opacity-85">
        <div className=" absolute w-full top-10 px-20 flex items-center text-blue">
          <h2 className="text-5xl font-bold mr-5">TITLE</h2>
          <p className=" font-bold text-2xl  ">
            Property Across All Over Ahmedabad
          </p>
        </div>
        <div className="flex justify-center items-center w-9/12">
          <div className=" text-blue">
            <p className=" font-bold text-3xl text-justify">
              There’s a smarter way to Find Property
            </p>
          ...
          <div className=" ml-20 pb-40 w-10/12 border bg-slate-50">
            <p className="h-20 flex items-center px-10 bg-gradient-to-r from-red-300 to bg-red-600 text-lg font-bold text-blue">
              Sign up
            </p>
            <div className="px-10">
              ...
              <input
                type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required
